...
def parse_datetime_with_timezone(time_str: str) -> Tuple[datetime, str]:
    ...
    - "2026-02-20T18:00:00+00:00" - ISO 8601 with offset
    ...
    # Try ISO 8601 format first (e.g., "2026-02-20T18:00:00+00:00")
    # These have embedded timezone offsets and don't need abbreviation extraction
    try:
        parsed = datetime.fromisoformat(time_str.strip())
        if parsed.tzinfo is not None:
            utc_result = parsed.astimezone(timezone.utc)
            return utc_result, "UTC"
    except (ValueError, TypeError):
        pass
